...
export default function EventosPage() {
  return (
    <div className="min-h-screen">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <p className="text-xl mb-8">
                Simplifique o processo de inscrição em eventos com um sistema automatizado de registro, pagamento e
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">
                Crie formulários de inscrição personalizados para coletar exatamente as informações que você precisa dos
                participantes.
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-2">Pagamento Integrado</h3>
              <p className="text-gray-600 mb-4">
                Ofereça múltiplas opções de pagamento e processe transações de forma segura diretamente no formulário de
                inscrição.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-2">Emissão de Credenciais</h3>
              <p className="text-gray-600 mb-4">
                Gere e envie automaticamente credenciais digitais com QR Code para facilitar o check-in no dia do
                evento.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Automatize todo o processo de inscrição, desde o registro até a emissão de credenciais, liberando sua
                equipe para outras tarefas.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Elimine erros manuais de registro e problemas de comunicação com um sistema automatizado e integrado.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Ofereça uma experiência de inscrição simples e profissional, aumentando a satisfação dos participantes
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Colete e analise dados importantes sobre os participantes para melhorar futuros eventos e ações de
                marketing.
              </p>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Check-in Automatizado para Eventos</h2>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Configuramos o sistema de acordo com as necessidades do seu evento, incluindo formulários e opções de
                pagamento.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Os participantes se inscrevem online, preenchendo o formulário e realizando o pagamento quando
                aplicável.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                O sistema envia automaticamente confirmações e credenciais com QR Code para os participantes.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                No dia do evento, os participantes são registrados rapidamente através da leitura do QR Code.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Conferências e Congressos</h3>
              <p className="text-gray-600">
                Eventos profissionais com múltiplas palestras, workshops e grande número de participantes.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Feiras e Exposições</h3>
              <p className="text-gray-600">
                Eventos comerciais com múltiplos expositores e visitantes que precisam de credenciamento eficiente.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Eventos educacionais que exigem inscrição prévia, pagamento e controle de presença dos participantes.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Pronto para simplificar o registro do seu evento?</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Entre em contato conosco hoje mesmo e descubra como nossa solução de registro de eventos pode transformar a
            experiência dos seus participantes.
          </p>
          <Button asChild size="lg" className="bg-white text-blue-700 hover:bg-gray-100">
            <Link href="/contato">Solicite uma demonstração</Link>
          </Button>
