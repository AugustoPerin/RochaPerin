  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Benefícios dos Chatbots Empresariais</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Ofereça suporte aos seus clientes a qualquer hora do dia, todos os dias da semana, sem custos
                adicionais.
              </p>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Atenda milhares de clientes simultaneamente sem perda de qualidade ou tempo de espera.
              </p>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Obtenha insights valiosos sobre seus clientes para melhorar produtos e serviços.
              </p>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Integre facilmente com sistemas existentes como CRM, ERP e plataformas de e-commerce.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Nossos Chatbots Especializados</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-4">Atendimento ao Cliente (SAC)</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <Link href="/servicos/chatbots/leads" className="text-blue-600 flex items-center hover:underline">
                Saiba mais <ArrowRight className="ml-1 w-4 h-4" />
              </Link>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-4">Pesquisas de Satisfação</h3>
              <p className="text-gray-600 mb-4">
              ...
              <Link href="/servicos/chatbots/pesquisas" className="text-blue-600 flex items-center hover:underline">
                Saiba mais <ArrowRight className="ml-1 w-4 h-4" />
              </Link>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <Link href="/servicos/chatbots/cobranca" className="text-blue-600 flex items-center hover:underline">
                Saiba mais <ArrowRight className="ml-1 w-4 h-4" />
              </Link>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Implementamos, testamos e otimizamos o chatbot para garantir o melhor desempenho e experiência do
                usuário.
              </p>
            </div>
          </div>
