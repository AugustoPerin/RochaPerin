...
export default function OfertasPage() {
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              <h1 className="text-4xl font-bold mb-4">Ofertas Promocionais Personalizadas</h1>
              <p className="text-xl mb-8">
                Envie ofertas personalizadas aos clientes com base em seu histórico de compras e preferências,
                aumentando as taxas de conversão e o valor médio do pedido.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">
                Crie ofertas altamente personalizadas com base no histórico de compras, comportamento de navegação e
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-2">Segmentação de Clientes</h3>
              <p className="text-gray-600 mb-4">
                Divida sua base de clientes em segmentos estratégicos para enviar ofertas mais relevantes e eficazes.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start">
                  <CheckCircle className="text-green-500 mr-2 flex-shrink-0 mt-1" size={16} />
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">
                Acompanhe o desempenho das suas ofertas com métricas detalhadas para otimizar continuamente suas
                campanhas.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Impulsione as vendas com ofertas relevantes que atendem às necessidades e desejos específicos de cada
                cliente.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Aumente o engajamento dos clientes com comunicações personalizadas que demonstram que você entende suas
                preferências.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Recupere vendas perdidas com ofertas personalizadas para clientes que abandonaram carrinhos ou
                interromperam o processo de compra.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Fortaleça o relacionamento com seus clientes através de ofertas exclusivas que aumentam a lealdade à
                marca.
              </p>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Tipos de Ofertas Personalizadas</h2>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                O sistema coleta e analisa dados de comportamento, histórico de compras e preferências dos clientes.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Os clientes são segmentados em grupos com base em comportamentos e características similares.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Ofertas personalizadas são criadas para cada segmento, maximizando a relevância e o impacto.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                As ofertas são entregues pelos canais preferidos e os resultados são analisados para otimização
                contínua.
              </p>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Canais de Entrega</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Envie ofertas personalizadas diretamente para a caixa de entrada dos seus clientes com designs atrativos
                e mensagens persuasivas.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Alcance seus clientes em tempo real com mensagens diretas contendo ofertas exclusivas e códigos
                promocionais.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Exiba ofertas personalizadas diretamente no seu site ou aplicativo, adaptadas ao comportamento de
      ...
      <section className="py-16 bg-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Pronto para aumentar suas vendas com ofertas personalizadas?</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Transforme seus dados em estratégias de vendas eficazes e ofereça aos seus clientes exatamente o que eles
            desejam, no momento certo.
          </p>
          <Button asChild size="lg" className="bg-white text-blue-700 hover:bg-gray-100">
            <Link href="/contato">Solicite uma demonstração</Link>
          </Button>
