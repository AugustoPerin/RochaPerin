    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-5xl">
          ...
          {/* Benefits */}
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Benefícios do Check-in Automatizado</h2>
          ...
          {/* Use Cases */}
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Aplicações Ideais</h2>
