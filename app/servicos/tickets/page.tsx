...
export default function TicketsPage() {
  return (
    <div className="min-h-screen">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <p className="text-xl mb-8">
                Automatize o processo de abertura e categorização de tickets de suporte com um chatbot inteligente que
                direciona as solicitações para os departamentos corretos.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">
                Identifique automaticamente o tipo de problema e direcione o ticket para o departamento ou especialista
                correto.
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-2">Priorização Inteligente</h3>
              <p className="text-gray-600 mb-4">
                Determine automaticamente a prioridade dos tickets com base na urgência, impacto e perfil do cliente.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start">
                  <CheckCircle className="text-green-500 mr-2 flex-shrink-0 mt-1" size={16} />
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-2">Integração com Helpdesk</h3>
              <p className="text-gray-600 mb-4">
                Conecte-se perfeitamente com os principais sistemas de helpdesk para uma gestão centralizada de tickets.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start">
                  <CheckCircle className="text-green-500 mr-2 flex-shrink-0 mt-1" size={16} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Reduza o tempo de resposta inicial com a abertura e categorização automática de tickets, melhorando a
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Otimize o fluxo de trabalho da equipe de suporte, direcionando os tickets para os especialistas certos
                desde o início.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Garanta que todas as informações necessárias sejam coletadas antes de criar o ticket, evitando idas e
                vindas.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Resolva problemas comuns automaticamente, antes mesmo da criação de um ticket, com respostas
                pré-programadas.
              </p>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Fluxo de Trabalho Otimizado</h2>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                O cliente inicia o contato através de um dos canais disponíveis (chat, WhatsApp, e-mail, etc.).
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                O chatbot identifica o problema e coleta todas as informações necessárias para criar o ticket.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                O sistema cria automaticamente um ticket categorizado e priorizado no sistema de helpdesk.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                O cliente recebe atualizações automáticas sobre o status do ticket até a resolução final.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Equipes de suporte técnico que precisam gerenciar um grande volume de solicitações de forma eficiente.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Empresas que desejam otimizar o processo de atendimento ao cliente e reduzir o tempo de resposta.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Departamentos de TI e RH que gerenciam solicitações internas de funcionários e precisam de organização.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Pronto para otimizar seu processo de suporte?</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Entre em contato conosco hoje mesmo e descubra como nossa solução de abertura de tickets pode transformar
