    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-2">Catálogo de Produtos</h3>
              <p className="text-gray-600 mb-4">
                Apresente seus produtos de forma organizada e atraente diretamente no WhatsApp, com imagens, descrições
                e preços.
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">
                Permita que os clientes adicionem produtos ao carrinho, ajustem quantidades e finalizem a compra sem
                sair do WhatsApp.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">
                Ofereça múltiplas opções de pagamento diretamente pelo WhatsApp, tornando o processo de compra rápido e
                conveniente.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Aproveite a popularidade e familiaridade do WhatsApp para criar um novo canal de vendas eficiente e
                acessível.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Combine automação com atendimento humano quando necessário, oferecendo suporte personalizado durante a
                jornada de compra.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Aproveite um canal que seus clientes já utilizam, sem necessidade de desenvolver aplicativos ou sites
                complexos.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Pequenas e médias empresas que desejam oferecer uma experiência de compra digital sem grandes
                investimentos.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Restaurantes e Delivery</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Serviços por Assinatura</h3>
              <p className="text-gray-600">
      ...
      <section className="py-16 bg-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Pronto para vender pelo WhatsApp?</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Entre em contato conosco hoje mesmo e descubra como nossa solução de WhatsApp Shopping pode transformar seu
            negócio.
          </p>
          <Button asChild size="lg" className="bg-white text-blue-700 hover:bg-gray-100">
            <Link href="/contato">Solicite uma demonstração</Link>
