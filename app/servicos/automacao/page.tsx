  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              <h1 className="text-4xl font-bold mb-4">Automação de Processos</h1>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Nossas Soluções de Automação</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <Link href="/servicos/automacao/agendamento" className="text-blue-600 flex items-center hover:underline">
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <Link href="/servicos/automacao/cotacao" className="text-blue-600 flex items-center hover:underline">
                Saiba mais <ArrowRight className="ml-1 w-4 h-4" />
              </Link>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <Link href="/servicos/automacao/rastreamento" className="text-blue-600 flex items-center hover:underline">
                Saiba mais <ArrowRight className="ml-1 w-4 h-4" />
              </Link>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <Link href="/servicos/automacao/eventos" className="text-blue-600 flex items-center hover:underline">
                Saiba mais <ArrowRight className="ml-1 w-4 h-4" />
              </Link>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-2">Agendamento de Exames</h3>
              <p className="text-gray-600 mb-4">
              ...
              <Link href="/servicos/automacao/exames" className="text-blue-600 flex items-center hover:underline">
                Saiba mais <ArrowRight className="ml-1 w-4 h-4" />
              </Link>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Benefícios da Automação de Processos</h2>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Como Implementamos a Automação</h2>
