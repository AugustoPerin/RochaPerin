          ...
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-white text-white hover:bg-white/10 px-8 py-6 font-medium text-base rounded-full"
              >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 z-20 transform transition-transform duration-300">
                <h3 className="text-xl font-semibold mb-2 text-white">Agendamento Automatizado</h3>
                <p className="text-gray-200 mb-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
